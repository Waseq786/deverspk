            ...
            <div>
                <div>
                    <div className='absolute -z-10 w-auto mx-4'>
                        <img src="/04.jpg" alt="..." className='w-[1500px] lg:w-[1465px] lg:h-[480px] h-[1580px]'/>
                    </div>


                    <div className='grid grid-cols-1 lg:grid-cols-3 font-sans mx-12 gap-6 lg:gap-x-16 p-4 mt-8'>
